...
public class tryingTwo {
       ...
       //file path for Kanye
        ...
        while (continue_go) {
            if (userAgreement.equalsIgnoreCase("yes")) {
                ...
                if ((UserGuessed(scnr, tweetChosen, userResponse, arrayKanye, arrayElon))== false){
     ...
     */
    public static boolean UserGuessed(Scanner scnr, String tweet, String response,
                                      String[] arrayKanye,
                                      String[] arrayElon) {
        boolean found = false;
        boolean exit = true;
        if (response.equalsIgnoreCase("YE")) {
            ...
            while (!((response.equalsIgnoreCase("MUSK")||(response.equalsIgnoreCase("Ye"))))) {
                System.out.println("You entered an invalid response...");
                System.out.println("Please type in \"ye\" for kanye and \"musk\" for elon");
